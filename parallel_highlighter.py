# Implementación paralela en Python de un resaltador de sintaxis de C#.
...
# Procesamiento paralelo con ThreadPoolExecutor que limita el número de hilos a la cantidad de archivos de C#
with ThreadPoolExecutor(max_workers=len(csharp_files)) as executor:
    executor.map(highlight_file, csharp_files)
